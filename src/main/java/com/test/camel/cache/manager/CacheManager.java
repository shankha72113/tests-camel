package com.test.camel.cache.manager;

import com.test.camel.cache.service.Cacheable;

public class CacheManager {
	  private static CacheManager singleTonInstance = null;
	/* This is the HashMap that contains all objects in the cache. */
	  private static java.util.HashMap<Integer,Object> cacheHashMap = new java.util.HashMap<>();
	...
	continuously */
	  ...
	  public CacheManager getInstance() {
		  if (singleTonInstance == null) {
			  System.out.println("Instance NULL creating new.");
			    singleTonInstance = new CacheManager();
		  }
		  System.out.println("HashCode of CacheManager:::::"+singleTonInstance.hashCode());
